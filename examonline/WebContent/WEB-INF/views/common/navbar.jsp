...
<nav class="uk-navbar-container uk-container-expand" uk-navbar>
	...
	<div class="uk-navbar-right">
		<ul class="uk-navbar-nav uk-visible@m">
			<li><a href="account/account-overview.htm">Manage Working Account</a></li>
			<li><a href="#"><span uk-icon="icon: user"></span> HungPham
					<span uk-icon="chevron-down"></span></a>
				<div class="uk-navbar-dropdown">
					<ul class="uk-nav uk-navbar-dropdown-nav">
						<li><a><span uk-icon="icon: sign-out"></span> Sign out</a></li>
					</ul>
				</div></li>
		</ul>
			...
			<div class="uk-offcanvas-bar">
				<div class="uk-panel">
					...
					<ul class="uk-nav uk-nav-default tm-nav">
						...
						<li class="uk-active"><a href="#">Edit Account Information</a></li>
